...
public class Ledger {
    ...
    @Id
    @Column(name = "id_ledger", nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        if (idLedger != null ? !idLedger.equals(ledger.idLedger) : ledger.idLedger != null) return false;
    ...
    @Override
    public int hashCode() {
        int result = idLedger != null ? idLedger.hashCode() : 0;
